...
class Jucema(StubJuntaScraper):
    sigla = "JUCEMA"
    uf = "MA"
    base_url = "https://www.jucema.ma.gov.br"
    reason = (
        "requires_manual_request: JUCEMA mantém só PDFs/portarias — sem listagem aberta."
    )
